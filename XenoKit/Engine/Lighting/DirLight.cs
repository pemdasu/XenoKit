...
namespace XenoKit.Engine.Lighting
{
    ...
    {
        private SimdVector4? directionOverride;
        ...
        {
            directionOverride = new SimdVector4(direction, 0f);
        }
        ...
        public Vector4 GetLightDirection(Matrix4x4 WVP, SimdVector3? actorDirectionOverride = null)
        {
            ...
            SimdVector4 baseDir = actorDirectionOverride.HasValue
                ? new SimdVector4(actorDirectionOverride.Value, 0f)
                : directionOverride ?? new SimdVector4(-0.4f, 0.0f, -0.55f, 0);
