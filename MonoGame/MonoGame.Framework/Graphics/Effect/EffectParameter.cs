...
namespace Microsoft.Xna.Framework.Graphics
{
	...
	public class EffectParameter
	{
        ...
        /// </summary>
        public static ulong NextStateKey { get; private set; }

        public EffectParameter(   EffectParameterClass class_, 
                                    ...
                                    object data )
		{
            ...
            //Happy now MonoGame?
            if (Elements == null)
                Elements = new EffectParameterCollection(new EffectParameter[0]);

		}

        public EffectParameter(EffectParameter cloneSource)
        {
            ...
            else
            {
                switch (ParameterClass)
                {
                    ...
                    case EffectParameterClass.Object:
                        ...
                        // Display "...".
                    case EffectParameterClass.MatrixRowsMajor:
                    case EffectParameterClass.MatrixColumnsMajor:
                        valueStr = "...";
                        break;
        ...
        */
		...
		{
            if ((ParameterClass != EffectParameterClass.MatrixRowsMajor && ParameterClass != EffectParameterClass.MatrixColumnsMajor) || ParameterType != EffectParameterType.Single)
                throw new InvalidCastException();
        ...
        */
        ...
        public void SetVector4(float[] value, float scale)
        {
            if (ParameterClass != EffectParameterClass.Vector || ParameterType != EffectParameterType.Single)
                throw new InvalidCastException();

            var fData = (float[])Data;
            fData[0] = value[0] * scale;
            fData[1] = value[1] * scale;
            fData[2] = value[2] * scale;
            fData[3] = value[3] * scale;
            StateKey = unchecked(NextStateKey++);
        }
